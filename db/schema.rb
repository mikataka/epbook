...
ActiveRecord::Schema.define(version: 20160714024634) do
  ...
  create_table "books", force: :cascade do |t|
    ...
    t.string   "isbn",          default: "978",                null: false
    t.string   "author",        default: "Firstname Lastname"
    t.integer  "price"
    t.string   "publish"
    t.date     "published"
    t.integer  "place_id"
    t.string   "br"
    t.boolean  "arrival",       default: true,                 null: false
  ...
  create_table "users", force: :cascade do |t|
    ...
    t.datetime "created_at",                                            null: false
    t.datetime "updated_at",                                            null: false
    t.string   "username",               default: "Firstname Lastname", null: false
    t.integer  "book_id"
  end
